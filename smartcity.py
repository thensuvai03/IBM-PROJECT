...
Original file is located at
    https://colab.research.google.com/drive/1ac2bMjhUvfw4jmgDoA-zv-hn-ETEbdnD
"""
...
def eco_tips_generator(problem_keywords):
  prompt = f"generate practical and actionable eco-friendly tips for sustainable living related to: {problem_keywords}.provide specific solution and suggestions:"
...
def policy_summarization(pdf_file, policy_text):
  ...
  if pdf_file is not None:
    ...
    summary_prompt = f"summarize the policy document and extra the most important point,key provisions,and implications:\n\n{policy_text} "
